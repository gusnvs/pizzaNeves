...
CREATE TABLE "catogories" (
    ...
    CONSTRAINT "catogories_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "catogories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
