  ...
  return (
    <>
      ...
      <Flex width="full" h="100vh" align="center" justifyContent="center" >
        <Box p={8} maxWidth="500px" borderWidth={1} borderRadius={8} boxShadow="lg" bg={useColorModeValue('gray.100', 'gray.700')} >
          <Box maxWidth="full" mb={10} >
            <Image w="250px" src={logoPrincipal.src} alt="PizzaNeves Logo" mx="auto" />
          </Box>
          <Box textAlign="center" mb={8}>
            <Heading fontSize="md">Faça seu login</Heading>
          </Box>
          <Box my={4} textAlign="left" >
            <form onSubmit={handleLogin}>
              <FormControl isRequired>
                <FormLabel>Email</FormLabel>
                <Input type="email" placeholder="email@pizzaneves.com" value={email} onChange={(e) => setEmail(e.target.value)} />
              </FormControl>
            ...
            <Box textAlign="center" mt={3} >
              <Link href="/signup">
                <Text color="gray" fontSize="sm">Não possui uma conta? Cadastre-se.</Text>
              </Link>
            </Box>
          </Box>
        </Box>
